        ...
        <PaperProvider>
            <View>
                <CustomHeader title={"Japan Gogo"}>
                    ...
                    <GradientPopupMenu>
                        <CustomMenuItem title={"Edit"} onPress={() => console.log('Edit')} icon={"edit"} />
                        <CustomMenuItem title={"Add Schedule"} onPress={() => console.log('Add Schedule')} icon={"edit-calendar"} />
                        <CustomMenuItem title={"Share"} onPress={() => console.log('Share')} icon={"share"} />
                        <CustomMenuItem title={"Delete"} onPress={() => console.log('Delete')} icon={"delete-outline"} />
                    </GradientPopupMenu>
                </CustomHeader>
